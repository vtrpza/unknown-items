...
interface MainFeedProps {
  initialSort?: 'recent' | 'popular' | 'unsolved';
}

export function MainFeed({ initialSort = 'recent' }: MainFeedProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-2 justify-center">
        ...
        <Button
          variant={sort === 'unsolved' ? 'default' : 'outline'}
          size="sm"
        ...
        {!loading && posts.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              Be the first to share a mystery!
            </p>
          </div>
        )}
